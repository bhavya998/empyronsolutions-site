...
const operations = [
    {
        title: "North America",
        icon: Globe,
        description: "Primary innovation hubs deploying high-throughput agentic networks for Fortune 500 financial and tech sectors.",
        gradient: "from-[#39ff14] to-[#00ffff]"
    },
    {
        title: "Europe (EMEA)",
        icon: ShieldCheck,
        description: "Strictly GDPR-compliant AI pipelines designed for sovereign data handling and verifiable governance protocols.",
        gradient: "from-[#00ffff] to-[#b026ff]"
    },
    {
        title: "Global Infrastructure",
        icon: Server,
        description: "Distributed, latency-optimized inference clusters ensuring 24/7 availability and fault-tolerant operations worldwide.",
...
export default function EnterpriseSection() {
    return (
        <section id="enterprise" className="py-20 md:py-40 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="container mx-auto px-6">
                <div className="mb-24 max-w-7xl mx-auto text-center">
                    ...
                    >
                        Global <span className="text-gradient-accent">Enterprise Operations</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Mission-critical AI infrastructure serving clients across the USA and Europe. Ensuring compliance, speed, and sovereignty.
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    {operations.map((op, index) => (
                        ...
                        >
                            ...
                            {/* Hover Gradient Glow */}
                            <div className={`absolute -inset-[1px] rounded-2xl bg-gradient-to-br ${op.gradient} opacity-0 group-hover:opacity-20 blur-md transition-opacity duration-500`} />

                            <div className="p-10 h-full flex flex-col items-center text-center">
                                <div className="mb-6 relative">
                                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${op.gradient} p-[1px] flex items-center justify-center`}>
